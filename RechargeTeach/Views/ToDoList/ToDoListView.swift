...
//  RechargeTeach
//
//  Created by Nicole Fong on 4/8/24.
//
...
struct ToDoListView: View {
    ...
    @FetchRequest(entity: Task.entity(), sortDescriptors: [NSSortDescriptor(keyPath: \Task.dateCreated, ascending: false)]) var allTasks: FetchedResults<Task>
